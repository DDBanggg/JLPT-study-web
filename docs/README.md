...
6. `N3_Study_Web_Database_Architecture_v2.md`
7. `N3_Study_Web_UI_UX_v2.md`
8. `N3_Study_Web_Context_v2.md`
...
Operational procedures live in [`guides`](./guides), including the
[admin authentication bootstrap guide](./guides/admin-auth-bootstrap.md).

Historical bootstrap, handoff, implementation-planning, and completed tracker records
live in [`archive`](./archive). Archived files are retained for context and are not current
sources of truth.
